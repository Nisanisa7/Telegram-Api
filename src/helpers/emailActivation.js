...
const sendEmail = (email, username, token) =>{
    ...
    transporter.sendMail({
        ...
        subject: "Verify Your Email Address for Telegram", // Subject line
        html: `<!DOCTYPE html>
        <html lang="en">
        <head>
            <meta charset="UTF-8">
        ...
        <body>
            <div class="wrapper">
                <div class="container">
                    ...
                    <a href="http://localhost:4000/v1/auth/verification/${token}"><input type="button" value="VERIFY ACOOUNT" class="button"></a>
                </div>
            </div>
        </body>
        </html>`, // html body
